...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 2: En Chile, las personas son recompensadas por su inteligencia y habilidad") +
  theme(legend.position = "bottom") + 
  theme_blank()
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 3: En Chile, a quienes tienen padres ricos les va mucho mejor en la vida.") +
  theme(legend.position = "bottom") + 
  theme_blank()
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 4:En Chile, quienes tienen buenos contactos les va mejor en la vida.") +
  theme(legend.position = "bottom") + 
  theme_blank()
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 5: Quienes más se esfuerzan deberían obtener mayores recompensas que quienes se esfuerzan menos.") +
  theme(legend.position = "bottom") + 
  theme_blank()
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 6: Quienes poseen más talento deberían obtener mayores recompensas que quienes poseen menos talento.") +
  theme(legend.position = "bottom") + 
  theme_blank()
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 7:  Está bien que quienes tienen padres ricos les vaya bien en la vida.") +
  theme(legend.position = "bottom") + 
  theme_blank()
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 8: Está bien que quienes tienen buenos contactos les vaya bien en la vida.") +
  theme(legend.position = "bottom") + 
  theme_blank()
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
       caption = "Fuente: EDUMER",
       title = "Figura 9:  En Chile, todas las personas tienen las mismas oportunidades para salir adelante..") +
  theme(legend.position = "bottom") + 
  theme_blank()
