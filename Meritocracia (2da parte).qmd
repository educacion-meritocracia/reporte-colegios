...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura : En Chile, a quienes tienen padres ricos les va mucho \n mejor en la vida",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_3))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title ="Figura 1.11: En Chile, a quienes tienen padres ricos les va mucho \n mejor en la vida") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pe <- pe %>% 
  ...
  geom_shadowtext(data = etiquetas.pe,
    ...
    labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.12: En Chile, quienes tienen buenos contactos les va mejor \n en la vida") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.13: En Chile, quienes tienen buenos contactos les va mejor \n en la vida",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_4))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.14: En Chile, quienes tienen buenos contactos les va mejor en la vida") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pe <- pe %>% 
  ...
  geom_shadowtext(data = etiquetas.pe,
   ...
   labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.15: En Chile, todas las personas tienen las mismas \n oportunidades para salir adelante") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.16: En Chile, todas las personas tienen las mismas \n oportunidades para salir adelante",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_9))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.17: En Chile, todas las personas tienen las mismas \n oportunidades para salir adelante") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pe <- pe %>% 
  ...
  geom_shadowtext(data = etiquetas.pe,
    ...
    labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.18: En Chile, Quienes más se esfuerzan deberían obtener mayores  \n recompensas que quienes se esfuerzan menos") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
   "Figura 1.19: Quienes más se esfuerzan deberían obtener mayores \n recompensas que quienes se esfuerzan menos",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_5))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.20: En Chile, Quienes más se esfuerzan deberían obtener mayores \n recompensas que quienes se esfuerzan menos") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p9_6))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.26: Está bien que las personas más inteligentes y/o talentosas ganen más dinero, \naun cuando requieran esforzarse menos para ello") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pe <- pe %>% 
  ...
  geom_shadowtext(data = etiquetas.pe,
    ...
    labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.27: Está bien que quienes tienen padres ricos les vaya bien en la vida") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
   "Figura 1.28: Está bien que quienes tienen padres ricos les vaya \n bien en la vida",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_7))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.29: Está bien que quienes tienen padres ricos les vaya \n bien en la vida") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pe <- pe %>% 
  ...
  geom_shadowtext(data = etiquetas.pe,
   ...
   labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.30: Está bien que quienes tienen buenos contactos les \n vaya bien en la vida") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.31: Está bien que quienes tienen buenos contactos les \n vaya bien en la vida",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_8))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.32: Está bien que quienes tienen buenos contactos les \n vaya bien en la vida") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pe <- pe %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.33: En esta escuela, quienes se esfuerzan obtienen buenas notas")+ 
  theme_blank() +
  theme(legend.position = "right",
        plot.title = element_text(size = 12, face = "italic", color = "black")) 
plot_pe
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.34: En esta escuela, quienes se esfuerzan obtienen buenas notas",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p2_1))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.35: En esta escuela, quienes se esfuerzan obtienen buenas notas") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pt <- pt %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.36: En esta escuela, quienes son inteligentes \nobtienen buenas notas") +
  theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_pt
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p2_2))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.38: En esta escuela, quienes son inteligentes obtienen buenas notas") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_pm <- pm %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.39: En esta escuela, los/as estudiantes \nobtienen las notas que merecen") + 
  theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_pm
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.40: En esta escuela, los/as estudiantes \nobtienen las notas que merecen",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p2_3))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.41: En esta escuela, los/as estudiantes obtienen las notas que merecen") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_ps <- ps %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Preferencia",
    caption = "Fuente: EDUMER",
    title = "Figura 1.42: ¿Qué es más importante para obtener buenas notas, \nel esfuerzo o la inteligencia?") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_ps
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.43: ¿Qué es más importante para obtener buenas notas, \nel esfuerzo o la inteligencia?",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p3))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Preferencia",
    title = "Figura 1.44: ¿Qué es más importante para obtener buenas notas, \nel esfuerzo o la inteligencia?") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_mn <- mn %>% 
  ...
  labs(y = "Porcentaje",
    ...
    caption = "Fuente: EDUMER",
    title = "Figura 1.45: ¿Te parece que este promedio fue más o menos \nde lo que merecías?") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_mn
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.46:  ¿Te parece que este promedio fue más o menos \nde lo que merecías?",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p5))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.47: ¿Te parece que este promedio fue más o menos de lo que merecías?") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
plot_mne <- mne %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Sensación de merecimiento",
    caption = "Fuente: EDUMER",
    title = "Figura 1.48: Tomando en cuenta el tiempo que le dedicas a tus estudios, \nlas notas que me saco son… ") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_mne
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.49:  Tomando en cuenta el tiempo que le dedicas a tus estudios, \nlas notas que me saco son… ",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p7))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.50: Tomando en cuenta el tiempo que le dedicas a tus estudios, \nlas notas que me saco son…") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
