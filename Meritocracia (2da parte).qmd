...
En la figura anterior se muestra que la diferencia entre olas es baja, mostrando una tendencia a la respuesta “Muy de acuerdo” con un (54%) aproximadamente, en ambas olas.
...
plot_pe <- pe %>% 
  ...
  geom_shadowtext(data = etiquetas.pe,
    ...
    labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.22:  En Chile, Quienes poseen más talento deberían obtener mayores \n recompensas que quienes poseen menos talento") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
En la figura se observa que la mayor diferencia de respuestas entre olas, están en las respuestas “En desacuerdo”, donde la primera ola cuenta con un (37%) y la segunda con un (45%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.23: En Chile, Quienes poseen más talento deberían obtener mayores \n recompensas que quienes poseen menos talento",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En los gráficos de dona se visualiza un porcentaje similar de respuesta entre los estudiantes de etapa básica y media. En ambos se observa una tendencia a la respuesta “Desacuerdo”, dónde básica tiene un (46%) y media (45%).
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_6))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.24: Quienes poseen más talento deberían obtener mayores \n recompensas que quienes poseen menos talento") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
En el primer gráfico de barras se muestra que los estudiantes con padres de un mayor nivel educacional tienen más porcentaje en la categoría “En desacuerdo” (39%) que los que tienen padres con menor nivel educacional (33%). Por parte de la variable género, se observa que las mujeres son más propensas a responder “En desacuerdo” (50%) que los hombres (37%). Respecto a la variable cantidad de libros en el hogar, no existe una mayor diferencia en las respuestas entre estudiantes que tengan más o menos libros.
...
plot_dm <- dm %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.25: Está bien que las personas más inteligentes y/o talentosas \nganen más dinero, aun cuando requieran esforzarse menos para ello") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_dm
...
En el gráfico se observa que las respuestas entre olas no varían más de un 5% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “De acuerdo”, donde la primera cuenta con un (44%) y la segunda (45%).
...
basica_esfuerzo <- db_students_w02 %>% dplyr::filter(nivel_estudiante_o2=="Básica") %>% 
  dplyr::select(p9_6_o2) #se filtran valores para esa categoría del curso

basica_esfuerzo = round(prop.table(table(categorias=basica_esfuerzo$p9_6_o2)),2) #se crean variables 'categoria' y 'Freq' del objeto
...
# categoría media
media_esfuerzo <- db_students_w02 %>% filter(nivel_estudiante_o2=="Media") %>% 
  dplyr::select(p9_6_o2) 

media_esfuerzo = round(prop.table(table(categorias=media_esfuerzo$p9_6_o2)),2)  
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.26: En Chile, Quienes poseen más talento deberían obtener mayores \n recompensas que quienes poseen menos talento",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En este gráfico se muestra que los estudiantes de media cuentan con un mayor porcentaje en la opción “De acuerdo” (49%) a diferencia de los de básica que cuentan con un (42%). 
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p9_6))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.27: Está bien que las personas más inteligentes y/o talentosas ganen más dinero, \naun cuando requieran esforzarse menos para ello") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
En el primer gráfico de barras se muestra que los estudiantes con padres de un mayor nivel educacional tienen más porcentaje en la categoría “Muy de acuerdo” (14%) que los que tienen padres con menor nivel educacional (8%). Por parte de la variable género, se observa que las mujeres son más propensas a estar en desacuerdo con la afirmación que los hombres. Respecto a la variable cantidad de libros en el hogar, no existe una mayor diferencia en las respuestas entre estudiantes que tengan más o menos libros, donde ninguna supera el 5%.
...
plot_pe <- pe %>% 
  ...
  geom_shadowtext(data = etiquetas.pe,
    ...
    labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.28: Está bien que quienes tienen padres ricos les vaya bien en la vida") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
En el gráfico se observa que las respuestas entre olas no varían más de un 5% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “De acuerdo”, donde la primera cuenta con un (45.7%) y la segunda (42.6%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
   "Figura 1.29: Está bien que quienes tienen padres ricos les vaya \n bien en la vida",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En estos gráficos se muestra que los estudiantes de básica cuentan con un mayor porcentaje en la opción “Desacuerdo” (42%) a diferencia de los de media que solo cuentan con un (31%).
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_7))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.30: Está bien que quienes tienen padres ricos les vaya \n bien en la vida") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
En el primer gráfico de barras se muestra que los estudiantes con padres de un mayor nivel educacional tienen más porcentaje en la categoría “Muy de acuerdo” (13%) que los que tienen padres con menor nivel educacional (6%). En la variable género se visualiza que las mujeres tienen un mayor porcentaje de respuesta en la categoría “Desacuerdo” (40%) a diferencia de los hombres que cuentan con un (33%). Por otra parte, la variable cantidad de libros en el hogar, presenta una diferencia en el porcentaje de la respuesta “De acuerdo” donde los estudiantes con más libros tienen (33%) y lo con menos libros (44%).
...
En el gráfico se observa que las respuestas entre olas no varían más de un 5% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “De acuerdo”, donde la primera cuenta con un (47.4%) y la segunda (45.5%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.32: Está bien que quienes tienen buenos contactos les \n vaya bien en la vida",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En los gráficos de dona se visualiza un porcentaje similar de respuesta entre los estudiantes de etapa básica y media. En ambos se observa una tendencia a la respuesta “Desacuerdo”, dónde básica tiene un (43%) y media (47%).
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p1_8))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.33: Está bien que quienes tienen buenos contactos les \n vaya bien en la vida") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
En el primer gráfico de barras se muestra que los estudiantes con padres de un mayor nivel educacional tienen más porcentaje en la categoría “Muy de acuerdo” (15%) que los que tienen padres con menor nivel educacional (8%). En la variable género se visualiza que los hombres tienen un mayor porcentaje de respuesta en la categoría “Desacuerdo” (49%) a diferencia de las mujeres que cuentan con un (42%). Asimismo, en la variable cantidad de libros en el hogar, presenta una diferencia en el porcentaje de la respuesta “Desacuerdo” donde los estudiantes con más libros tienen (34%) y lo con menos libros (48%).
...
En el gráfico se observa que las respuestas entre olas no varían más de un 5% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “De acuerdo”, donde la primera cuenta con un (48.9%) y la segunda (49.9%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.35: En esta escuela, quienes se esfuerzan obtienen buenas notas",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En este gráfico se muestra que los estudiantes de básica cuentan con un mayor porcentaje en la opción “Muy de acuerdo” (37%) a diferencia de los de media que cuentan con un (31%). 
...
En el primer gráfico de barras se observa que la diferencia entre porcentajes de respuesta de los estudiantes que tienen padres con menor o mayor nivel educativo no varía más de 3% en ninguna categoría de respuesta. La variable género se visualiza que las mujeres tienen un mayor porcentaje de respuesta en la categoría “De acuerdo” (54%) a diferencia de los hombres que cuentan con un (46%). Asimismo, en la variable cantidad de libros en el hogar, presenta una diferencia en el porcentaje de la respuesta “De acuerdo” donde los estudiantes con más libros tienen (44%) y lo con menos libros (51%).
...
plot_pt <- pt %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.37: En esta escuela, quienes son inteligentes \nobtienen buenas notas") +
  theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_pt
...
En la figura se observa que la mayor diferencia de respuestas entre olas, están en las respuestas “De acuerdo”, donde la primera ola cuenta con un (51.2%) y la segunda con un (57.5%).
...
En estos gráficos se muestra que los estudiantes de básica cuentan con un mayor porcentaje en la opción “De acuerdo” (58%) a diferencia de los de media que solo cuentan con un (51%). 
...
En el primer gráfico de barras se observa que la diferencia entre porcentajes de respuesta de los estudiantes que tienen padres con menor o mayor nivel educativo no varía más de 3% en ninguna categoría de respuesta. En la variable género se visualiza que las mujeres tienen un mayor porcentaje de respuesta en la categoría “De acuerdo” (63%) a diferencia de los hombres que cuentan con un (53%). Respecto a la variable cantidad de libros en el hogar, no existe una mayor diferencia en las respuestas entre estudiantes que tengan más o menos libros, donde ninguna supera el 3%.
...
plot_pm <- pm %>% 
  ...
  labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.40: En esta escuela, los/as estudiantes \nobtienen las notas que merecen") + 
  theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_pm
...
En el gráfico se observa que las respuestas entre olas no varían más de un 3% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “De acuerdo”, donde la primera cuenta con un (54.8%) y la segunda (55.5%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.41: En esta escuela, los/as estudiantes \nobtienen las notas que merecen",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En la figura se muestra que los estudiantes de básica cuentan con un mayor porcentaje en la opción “Muy de acuerdo” (24%) a diferencia de los de media que solo cuentan con un (18%). 
...
En el primer gráfico de barras se observa que la diferencia entre porcentajes de respuesta de los estudiantes que tienen padres con menor o mayor nivel educativo no varía más de 3% en ninguna categoría de respuesta. En la variable género se visualiza que los hombres tienen un mayor porcentaje de respuesta en la categoría “Muy de acuerdo” (23%) a diferencia de las mujeres que cuentan con un (18%). Respecto de la variable cantidad de libros en el hogar, se presenta una diferencia en el porcentaje de la respuesta “De acuerdo” donde los estudiantes con más libros tienen (50%) y lo con menos libros (56%).
...
En el gráfico se observa que las respuestas entre olas no varían más de un 3% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “Ambos”, donde la primera cuenta con un (49.7%) y la segunda (51.5%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.44: ¿Qué es más importante para obtener buenas notas, \nel esfuerzo o la inteligencia?",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En los gráficos de dona se visualiza un porcentaje similar de respuesta entre los estudiantes de etapa básica y media. En ambos se observa una tendencia a la respuesta “Ambos”, dónde básica tiene un (53%) y media (50%).
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p3))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Preferencia",
    title = "Figura 1.45: ¿Qué es más importante para obtener buenas notas, \nel esfuerzo o la inteligencia?") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
En el primer gráfico de barras se muestra que los estudiantes con padres de un mayor nivel educacional tienen más porcentaje en la categoría “Esfuerzo” (30%) que los que tienen padres con menor nivel educacional (24%). En la variable género se visualiza que los hombres tienen un mayor porcentaje de respuesta en la categoría “Talento” (25%) a diferencia de las mujeres que cuentan con un (20%). Además, ambos cuentan con el mismo porcentaje en la respuesta” Esfuerzo”. Respecto a la variable cantidad de libros en el hogar, no existe una mayor diferencia en las respuestas entre estudiantes que tengan más o menos libros, donde ninguna supera el 3%.
...
plot_mn <- mn %>% 
  ...
  labs(y = "Porcentaje",
    ...
    caption = "Fuente: EDUMER",
    title = "Figura 1.46: ¿Te parece que este promedio fue más o menos \nde lo que merecías?") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_mn
...
En el gráfico se observa que las respuestas entre olas no varían más de un 2% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “Lo que merezco”, donde la primera cuenta con un (77.8%) y la segunda (78.1%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.47:  ¿Te parece que este promedio fue más o menos \nde lo que merecías?",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En los gráficos de dona se visualiza un porcentaje similar de respuesta entre los estudiantes de etapa básica y media. En ambos se observa una tendencia a la respuesta “Lo que merezco”, dónde básica tiene un (79%) y media (77%).
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p5))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.48: ¿Te parece que este promedio fue más o menos de lo que merecías?") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
En el primer gráfico de barras se observa que la diferencia entre porcentajes de respuesta de los estudiantes que tienen padres con menor o mayor nivel educativo no varía más de 3% en ninguna categoría de respuesta.  En la variable género no se presentan diferencia que superen el 5% entre las respuestas de hombres y mujeres. Respecto a la variable cantidad de libros en el hogar, no existe una mayor diferencia en las respuestas entre estudiantes que tengan más o menos libros, donde ninguna supera el 4%.
...
En el gráfico se observa que las respuestas entre olas no varían más de un 3% en ninguna respuesta. La respuesta más frecuente en ambas olas es la alternativa “Lo que merezco”, donde la primera cuenta con un (71.8%) y la segunda (73.3%).
...
plot_es_percep_curso <- annotate_figure(
  esfuerzo_curso,
  top = text_grob(
    "Figura 1.50:  Tomando en cuenta el tiempo que le dedicas a tus estudios, \nlas notas que me saco son… ",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
En los gráficos de dona se visualiza un porcentaje similar de respuesta entre los estudiantes de etapa básica y media. En ambos se observa una tendencia a la respuesta “Lo que merezco”, dónde básica tiene un (74%) y media (72%).
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p7))) +
  ...
  labs(
    ...
    y = NULL,
    fill = "Grado de acuerdo",
    title = "Figura 1.51: Tomando en cuenta el tiempo que le dedicas a tus estudios, \nlas notas que me saco son…") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
En el primer gráfico de barras se observa que la diferencia entre porcentajes de respuesta de los estudiantes que tienen padres con menor o mayor nivel educativo no varía más de 3% en ninguna categoría de respuesta.  En la variable género no se presentan diferencia que superen el 5% entre las respuestas de hombres y mujeres. Respecto de la variable cantidad de libros en el hogar, se presenta una diferencia en el porcentaje de la respuesta “Lo que merezco” donde los estudiantes con más libros tienen (63%) y lo con menos libros (75%).
