...
plot_participar <- participar %>%
 ...
 labs(y = "Porcentaje",
    ...
    title = "Figura 1.1: Cuando sea adulto(a) podré participar en la política") +
   theme_blank() +
...
labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.1: Comprendo bien las problemáticas políticas de nuestro país") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
plot_comprender
...
plot_formciud <- formciud %>%
 ...
 labs(y = "Porcentaje",
       ...
       fill = "Grado de acuerdo",
    caption = "Fuente: EDUMER",
    title = "Figura 1.1: ¿Cuánta importancia dirías tú que se le da la  \nFormación Ciudadana en este establecimiento?") +
   theme_blank() +
  theme(legend.position = "right",
         plot.title = element_text(size = 12, face = "italic", color = "black"))
...
plot_es_formciud_curso <- annotate_figure(
  formciud_curso,
  top = text_grob(
    "Figura: ¿Cuánta importancia dirías tú que se le da a la  \n Formación Ciudadana en este establecimiento?",
    size = 12, 
    face = "italic", 
    color = "black",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(p12_o2))) + 
  ...
  labs(
    ...
    y = NULL, 
    fill = "Grado de acuerdo",
    title = "Figura: ¿Cuánta importancia dirías tú que se le da a la  \n Formación Ciudadana en este establecimiento?") +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
